export function IconList() {
    return (
        <ul className='flex gap-10 pt-10 pb-10'>
            <li className="list-item">
                <a href="#use" className="w-full h-full p-5">
            ...
            <li className="list-item">
                <a href="#aprendizado" className="w-full h-full p-5">
            ...
            <li className="list-item">
                <a href="#imersao" className="w-full h-full p-5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-exclude" viewBox="0 0 16 16">
            ...
            <li className="list-item">
                <a href="#confianca" className="w-full h-full p-5">
            ...
            <li className="list-item">
                <a href="#repertorio" className="w-full h-full p-5">
